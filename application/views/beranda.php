                        ...
                        <ul class="nav">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="<?= base_url('home/kategori/' . $kt['id_kategori']) ?>">
                                            <?= $kt['nama_kategori'] ?>
                                        </a>
                                    </li>
                                    <?php } ?>
                            ...
                            <li><a href=" <?= site_url('auth') ?>">Login</a>
                            </li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-12 mt-3">
                    <div class="section-heading">
                        <h2 style="text-align:center">Temukan Tempat Wisata Untuk Anda</h2>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="owl-courses-item owl-carousel">
                        <?php $no = 1;
                        foreach ($caraousel as $kn) { ?>
                        <div class="item"
                            style="paddinig: 100px; background-image: url(<?= base_url('assets/upload/caraousel/' . $kn['foto']) ?>);">
                            <img src="<?= base_url('assets/upload/caraousel/' . $kn['foto']) ?>" width="100%
                                padding:0px; ">
                        </div>
                        <?php $no++;
                        } ?>
                ...
                <div class="col-lg-12 mt-5">
                    <div class="row">
                        <div class="col-lg-12 mt-10">
                            <div class="filters">
                                <ul>
                                    <li data-filter="*" class="active"> Semua Wisata</li>
                                    <?php foreach ($kategori as $kt) { ?>
                                    <li data-filter=".a<?= $kt['id_kategori'] ?>">
                                        <?= $kt['nama_kategori'] ?>
                                    </li>
                                    <?php } ?>
                                </ul>
